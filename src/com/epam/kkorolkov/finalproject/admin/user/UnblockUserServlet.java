...
/**
 * The {@code UnblockUserServlet} is a servlet which task is to
 * update field {@code isBlocked} by setting it to {@code false}.
 *
 * Only {@code doPost} method is overridden.
 */
@WebServlet("/admin/unblock-user")
public class UnblockUserServlet extends HttpServlet {
    /** Logger */
    private static final Logger LOGGER = LogManager.getLogger("UNBLOCK USER");
